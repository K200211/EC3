...
public final class FragmentListBinding implements ViewBinding {
  ...
  @NonNull
  public final RecyclerView rvMovieLis;

  private FragmentListBinding(@NonNull ConstraintLayout rootView,
      @NonNull RecyclerView rvMovieLis) {
    this.rootView = rootView;
    this.rvMovieLis = rvMovieLis;
  }
  ...
  public static FragmentListBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.rvMovieLis;
      RecyclerView rvMovieLis = ViewBindings.findChildViewById(rootView, id);
      if (rvMovieLis == null) {
        break missingId;
      }

      return new FragmentListBinding((ConstraintLayout) rootView, rvMovieLis);
    }
